  ...
  for(var i=0; i < wTR.length; i++){
    ...
    for(var j=0; j < wTD.length; j++){
      ...
      if(wTD[j].getAttribute('cmanFilterBtn') !== null){
        ...
        wAddBtn += '<svg class="tfImg" id="tsBtn_'+j+'" onclick="tFilterCloseOpen('+j+')"><path d="M0 0 L12 0 L9 6 L9 12 L4.5 12 L4.5 6Z"></path></svg>';
...
//==============================================================
  ...
  rcList += '<input type="button" value="OK" class="tfBtn" onclick="tFilterGo()">';
  rcList += '<input type="button" value="Cancel" class="tfBtn" onclick="tFilterCancel('+argCol+')">';
  rcList += '</div>';
